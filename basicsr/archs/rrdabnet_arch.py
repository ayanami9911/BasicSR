...
class ResidualDenseBlock_3(nn.Module):
    ...
    def __init__(self, num_feat=64, num_grow_ch=32, ):
        super(ResidualDenseBlock_3, self).__init__()
...
class ResidualDenseBlock_7(nn.Module):
    """Residual Dense Block.
...
class RRDABNet(nn.Module):
    def __init__(self, num_in_ch, num_out_ch, scale=4, num_feat=64, num_block=23, num_grow_ch=32):
        ...
        self.body = make_layer(RRDAB, num_block, num_feat=num_feat, num_grow_ch=num_grow_ch)
